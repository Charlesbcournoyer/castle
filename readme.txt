...
1. Upload the `castle` folder to the `/wp-content/themes/` directory
...
* The MediaElement.js skin is designed and coded by Charles Cournoyer and is free for personal and commercial use.
...
http://www.charlescournoyer.com/support/forum/theme-support/castle
