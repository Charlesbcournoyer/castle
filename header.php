...
<body <?php body_class() ?>>
	<div id="wrapper">
		<header id="header">
			<<?php castle_title_tag( 'site' ); ?> id="site-title">
			...
			</<?php castle_title_tag( 'site' ); ?>>
			<?php if( ! is_active_sidebar( 1 ) ) : ?>
				<<?php castle_title_tag( 'desc' ); ?> id="site-description"><?php bloginfo( 'description' ); ?></<?php castle_title_tag( 'desc' ); ?>>
			<?php endif; ?>
